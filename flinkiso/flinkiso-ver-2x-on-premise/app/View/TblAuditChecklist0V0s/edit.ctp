...
<?php echo $this->fetch('script'); ?>
	<div class="custom_form" id="TblAuditChecklist0V0_div">	
	<?php echo $this->Session->flash();?>	
		<div class="TblAuditChecklist0V0">
			<?php 
			if($this->request->is('ajax') == false){
			echo $this->element('nav-header-lists',array('postData'=>array('friendlyName'=>'Audit Checklist','pluralHumanName'=>'Tbl Audit Checklist 0 V0s','modelClass'=>'TblAuditChecklist0V0','options'=>array(),'pluralVar'=>'tblAuditChecklist0V0s'))); 
			}?>
<?php if($this->action == 'edit'){ ?>
	<div id="load_parent">
	<?php if($this->request->data['TblAuditChecklist0V0']['parent_id'] && isset($parent_table_name)){ ?>
	<script type="text/javascript">
		$().ready(function(){
			$.ajax({
				url: "<?php echo Router::url('/', true); ?><?php echo $parent_table_name;?>/view/<?php echo $this->request->data['TblAuditChecklist0V0']['parent_id'];?>",
				type : "POST",
				data : {															
...
<div class="row">
	<div class="col-md-12">
		...
		?>
			...
			<?php echo $this->Form->create('TblAuditChecklist0V0',array('role'=>'form','class'=>'form','type'=>'file')); ?>
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('checklist_title',array( 'label' => 'Checklist Title', 'default'=>'', 'class'=>'form-control', $block_class , 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('date_added',array( 'label' => 'Date Added', 'class'=>'form-control', $block_class , 'required' , 'type'=>'date', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('added_by',array( 'label' => 'Added By', 'class'=>'form-control select AddedBy ' , $block_class , 'required' ,  'model'=>'AddedBy', 'onchange'=>'addsignature(this.value,this.id)', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('comments',array( 'label' => 'Comments', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
					<?php
...
<script> 
    ...
    $().ready(function() {
        ...
        $('#TblAuditChecklist0V0EditForm').validate();
        ...
        $("#submit_id").click(function(){
            if($('#TblAuditChecklist0V0EditForm').valid()){
				$("#submit_id").prop("disabled",true);
				$("#submit-indicator").show();
				$('#TblAuditChecklist0V0EditForm').submit();
            }
        });
	});
</script>
