...
<?php echo $this->element('nav-header-lists',array('postData'=>array('friendlyName'=>'Supplier Details','pluralHumanName'=>'tbl_supplier_details_0_v0s','modelClass'=>'TblSupplierDetails0V0','options'=>array("name"=>"Name","supplier_address"=>"Supplier Address","supplier_phone"=>"Supplier Phone","supplier_email"=>"Supplier Email","supplier_since"=>"Supplier Since","supplier_company_type"=>"Supplier Company Type","supplier_number"=>"Supplier Number","name"=>"Name","supplier_address"=>"Supplier Address","supplier_phone"=>"Supplier Phone","supplier_email"=>"Supplier Email","supplier_since"=>"Supplier Since","supplier_company_type"=>"Supplier Company Type","supplier_number"=>"Supplier Number"),'pluralVar'=>'tblSupplierDetails0V0s'))); ?>
<div id="load_parent">
    <?php if($tblSupplierDetails0V0['TblSupplierDetails0V0']['parent_id'] && isset($parent_table_name)){ ?>
    <script type="text/javascript">
        $().ready(function(){
            $.ajax({
                url: "<?php echo Router::url('/', true); ?><?php echo $parent_table_name;?>/view/<?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['parent_id'];?>",
                type : "POST",
                data : {                                                            
...
<div class="view-record"><h2><small>Supplier Number: </small><?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_number'];?></h2>
...
<br />
	...
	<div class="table-responsive">
		<table class="table table-bordered table-responsive" id="exportcsv"  >
			...
			<tr>
				<th width="30%"> Supplier Address</th>
                                <td><?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_address'];?></td>
			</tr>
			<tr>
				<th width="30%"> Supplier Phone</th>
                                <td><?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_phone'];?></td>
			</tr>
			<tr>
				<th width="30%"> Supplier Email</th>
                                <td><?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_email'];?></td>
			</tr>
			<tr>
				<th width="30%"> Supplier Since</th>
                                <td><?php 
                                if($tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_since'])echo  date(Configure::read('dateFormat'),strtotime($tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_since'])) ;
                                else echo "--"
                                ?></td>
			<tr>
				<th width="30%">Supplier Company Type</th>
	<td><?php echo $customArray['supplierCompanyTypes'][$tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_company_type']];?></td>
			</tr>
			<tr>
				<th width="30%"> Supplier Number</th>
                                <td><?php echo $tblSupplierDetails0V0['TblSupplierDetails0V0']['supplier_number'];?></td>
			</tr>
			<tr>
				<th width="30%">Prepared By</th>
				<td><?php 
				$img = WWW_ROOT. DS. 'img'. DS . $this->Session->read('User.company_id'). DS .'signature'. DS. $tblSupplierDetails0V0['PreparedBy']["id"] . DS. 'sign.png';

                        
				if(file_exists($img)){
                            
				$imgUrl = Router::url('/', true).'/img/' . $this->Session->read('User.company_id') .'/signature/'. $tblSupplierDetails0V0['PreparedBy']["id"] . '/sign.png';
                            
				echo '<img src="'.$imgUrl.'" width="100"><br />';
                        
				}else if($tblSupplierDetails0V0['PreparedBy']['signature']){
                            
				echo '<img src="'.$tblSupplierDetails0V0['PreparedBy']['signature'].'" width="100"><br />';
                        }else{ echo '<small style="color:#810000">Signature not found</small><br />';} 
				?><?php echo $tblSupplierDetails0V0['PreparedBy']['name'];?></td>
			</tr>
			<tr>
				<th width="30%">Approved By</th>
				<td><?php 
				$img = WWW_ROOT. DS. 'img'. DS . $this->Session->read('User.company_id'). DS .'signature'. DS. $tblSupplierDetails0V0['ApprovedBy']["id"] . DS. 'sign.png';

                        
				if(file_exists($img)){
                            
				$imgUrl = Router::url('/', true).'/img/' . $this->Session->read('User.company_id') .'/signature/'. $tblSupplierDetails0V0['ApprovedBy']["id"] . '/sign.png';
                            
				echo '<img src="'.$imgUrl.'" width="100"><br />';
                        
				}else if($tblSupplierDetails0V0['ApprovedBy']['signature']){
                            
				echo '<img src="'.$tblSupplierDetails0V0['ApprovedBy']['signature'].'" width="100"><br />';
                        }else{ echo '<small style="color:#810000">Signature not found</small><br />';} 
				?><?php echo $tblSupplierDetails0V0['ApprovedBy']['name'];?></td>
			</tr>
			<tr>
