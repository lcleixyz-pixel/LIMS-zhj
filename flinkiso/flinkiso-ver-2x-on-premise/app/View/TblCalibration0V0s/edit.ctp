...
<?php echo $this->fetch('script'); ?>
	<div class="custom_form" id="TblCalibration0V0_div">	
	<?php echo $this->Session->flash();?>	
		<div class="TblCalibration0V0">
			<?php 
			if($this->request->is('ajax') == false){
			echo $this->element('nav-header-lists',array('postData'=>array('friendlyName'=>'Calibration','pluralHumanName'=>'Tbl Calibration 0 V0s','modelClass'=>'TblCalibration0V0','options'=>array(),'pluralVar'=>'tblCalibration0V0s'))); 
			}?>
<?php if($this->action == 'edit'){ ?>
	<div id="load_parent">
	<?php if($this->request->data['TblCalibration0V0']['parent_id'] && isset($parent_table_name)){ ?>
	<script type="text/javascript">
		$().ready(function(){
			$.ajax({
				url: "<?php echo Router::url('/', true); ?><?php echo $parent_table_name;?>/view/<?php echo $this->request->data['TblCalibration0V0']['parent_id'];?>",
				type : "POST",
				data : {															
...
<div class="row">
	<div class="col-md-12">
		...
		?>
			...
			<?php echo $this->Form->create('TblCalibration0V0',array('role'=>'form','class'=>'form','type'=>'file')); ?>
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('number',array( 'label' => 'number', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('equipement',array( 'label' => 'Equipement', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('tool_details',array( 'label' => 'Tool Details', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('tool_location',array( 'label' => 'Tool Location', 'class'=>'form-control select ToolLocation ' , $block_class , 'required' ,  'showdocs'=> 0 ,'showdocs_mode'=>0 , 'showdocs_copy'=> 0 , 'model'=>'ToolLocation', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('calibration_frequency',array( 'label' => 'Calibration Frequency', 'class'=>'form-control select CalibrationFrequency ' , $block_class , 'required' ,  'showdocs'=> 0 ,'showdocs_mode'=>0 , 'showdocs_copy'=> 0 , 'model'=>'CalibrationFrequency', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('previous_calibration_date',array( 'label' => 'Previous Calibration Date', 'class'=>'form-control', $block_class , 'type'=>'date', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('next_calibration_date',array( 'label' => 'Next Calibration Date', 'class'=>'form-control', $block_class , 'type'=>'date', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('calibration_performed_by',array( 'label' => 'Calibration Performed By', 'class'=>'form-control select CalibrationPerformedBy ' , $block_class , 'required' ,  'showdocs'=> 0 ,'showdocs_mode'=>0 , 'showdocs_copy'=> 0 , 'model'=>'CalibrationPerformedBy', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<div class='col-md-12'><div class='show_comments'><i class="fa  fa-exclamation-triangle"></i>You can add actual calibration readings inside the calibration document.</div></div>
					<?php
...
<script> 
    ...
    $().ready(function() {
        ...
        $('#TblCalibration0V0EditForm').validate();
        ...
        $("#submit_id").click(function(){
            if($('#TblCalibration0V0EditForm').valid()){
				$("#submit_id").prop("disabled",true);
				$("#submit-indicator").show();
				$('#TblCalibration0V0EditForm').submit();
            }
        });
	});
</script>
