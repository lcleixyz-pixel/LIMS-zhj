...
<?php echo $this->fetch('script'); ?>
	<div class="custom_form" id="TblDeviceEquipment0V0_div">	
	<?php echo $this->Session->flash();?>	
		<div class="TblDeviceEquipment0V0">
			<?php 
			if($this->request->is('ajax') == false){
			echo $this->element('nav-header-lists',array('postData'=>array('friendlyName'=>'Device Equipment','pluralHumanName'=>'Tbl Device Equipment 0 V0s','modelClass'=>'TblDeviceEquipment0V0','options'=>array(),'pluralVar'=>'tblDeviceEquipment0V0s'))); 
			}?>
<?php if($this->action == 'edit'){ ?>
	<div id="load_parent">
	<?php if($this->request->data['TblDeviceEquipment0V0']['parent_id'] && isset($parent_table_name)){ ?>
	<script type="text/javascript">
		$().ready(function(){
			$.ajax({
				url: "<?php echo Router::url('/', true); ?><?php echo $parent_table_name;?>/view/<?php echo $this->request->data['TblDeviceEquipment0V0']['parent_id'];?>",
				type : "POST",
				data : {															
...
<div class="row">
	<div class="col-md-12">
		...
		?>
			...
			<?php echo $this->Form->create('TblDeviceEquipment0V0',array('role'=>'form','class'=>'form','type'=>'file')); ?>
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">						<?php $block_class = '';?>
						...
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('equipment_name',array( 'label' => 'Equipment Name', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('location',array( 'label' => 'Location', 'class'=>'form-control select Location ' , $block_class , 'required' ,  'showdocs'=> 0 ,'showdocs_mode'=>0 , 'showdocs_copy'=> 0 , 'model'=>'Location', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('in_service_since',array( 'label' => 'In Service Since', 'class'=>'form-control', $block_class , 'required' , 'type'=>'date', 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('equipment_details',array( 'label' => 'Equipment Details', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('manufacturer_part_number',array( 'label' => 'Manufacturer Part Number', 'default'=>'', 'class'=>'form-control', $block_class , 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('maintenance_schedule',array( 'label' => 'Maintenance Schedule', 'class'=>'form-control select MaintenanceSchedule ' , $block_class , 'required' ,  'showdocs'=> 0 ,'showdocs_mode'=>0 , 'showdocs_copy'=> 0 , 'model'=>'MaintenanceSchedule', 'onblur'=>'donothing()')) . "</div>";?>
					<?php
...
<script> 
    ...
    $().ready(function() {
        ...
        $('#TblDeviceEquipment0V0EditForm').validate();
        ...
        $("#submit_id").click(function(){
            if($('#TblDeviceEquipment0V0EditForm').valid()){
				$("#submit_id").prop("disabled",true);
				$("#submit-indicator").show();
				$('#TblDeviceEquipment0V0EditForm').submit();
            }
        });
	});
</script>
