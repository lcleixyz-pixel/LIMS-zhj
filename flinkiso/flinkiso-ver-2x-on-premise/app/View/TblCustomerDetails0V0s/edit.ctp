...
<?php echo $this->fetch('script'); ?>
	<div class="custom_form" id="TblCustomerDetails0V0_div">	
	<?php echo $this->Session->flash();?>	
		<div class="TblCustomerDetails0V0">
			<?php 
			if($this->request->is('ajax') == false){
			echo $this->element('nav-header-lists',array('postData'=>array('friendlyName'=>'Customer Details','pluralHumanName'=>'Tbl Customer Details 0 V0s','modelClass'=>'TblCustomerDetails0V0','options'=>array(),'pluralVar'=>'tblCustomerDetails0V0s'))); 
			}?>
<?php if($this->action == 'edit'){ ?>
	<div id="load_parent">
	<?php if($this->request->data['TblCustomerDetails0V0']['parent_id'] && isset($parent_table_name)){ ?>
	<script type="text/javascript">
		$().ready(function(){
			$.ajax({
				url: "<?php echo Router::url('/', true); ?><?php echo $parent_table_name;?>/view/<?php echo $this->request->data['TblCustomerDetails0V0']['parent_id'];?>",
				type : "POST",
				data : {															
...
<div class="row">
	<div class="col-md-12">
		...
		?>
			...
			<?php echo $this->Form->create('TblCustomerDetails0V0',array('role'=>'form','class'=>'form','type'=>'file')); ?>
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('customer_name',array( 'label' => 'Customer Name', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('customer_details',array( 'label' => 'Customer Details', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-4'>". $this->Form->input('official_email',array( 'label' => 'Official Email', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-4'>". $this->Form->input('phone',array( 'label' => 'Phone', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-4'>". $this->Form->input('fax',array( 'label' => 'Fax', 'default'=>'', 'class'=>'form-control', $block_class , 'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-12'>". $this->Form->input('head_office_address',array( 'label' => 'Head Office Address', 'default'=>'', 'class'=>'form-control', $block_class ,'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('customer_status',array('type'=>'radio', 'options' => $customArray['customerStatuses'],  'legend' => 'Customer Status', 'class'=>'', $block_class , 'required' ,  'onblur'=>'donothing()')) . "</div>";?>
						<?php $block_class = '';?>
						<?php echo "<div class='col-md-6'>". $this->Form->input('customer_type',array('type'=>'radio', 'options' => $customArray['customerTypes'],  'legend' => 'Customer Type', 'class'=>'', $block_class , 'required' ,  'onblur'=>'donothing()')) . "</div>";?>
					<?php
...
<script> 
    ...
    $().ready(function() {
        ...
        $('#TblCustomerDetails0V0EditForm').validate();
        ...
        $("#submit_id").click(function(){
            if($('#TblCustomerDetails0V0EditForm').valid()){
				$("#submit_id").prop("disabled",true);
				$("#submit-indicator").show();
				$('#TblCustomerDetails0V0EditForm').submit();
            }
        });
	});
</script>
