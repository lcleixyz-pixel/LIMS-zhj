#!/usr/bin/env python3
# validate.py v1.3 — 要素模板质检闸口(lab-qms-builder 工具层)
# 用法: python validate.py [--json] <要素模板.md>
# 检查: A章节完整性 B悬空回链 C无落点卡 D待核混入正文 E闭合声明标注
import re, sys, os
...
def main():
    ...
    result = build_result('validate', '1.3', errors=findings, warnings=warns, extra=extra)
