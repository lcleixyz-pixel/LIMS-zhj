...
BEGIN
    ...
    SELECT 'c402ff6e-357c-4485-99ea-718916721eba', '00000000-0000-0000-0000-000000000001', 'c7264cf5-873e-4300-a9fc-866047c45879', 'E008', '如则托合提·阿卜杜加帕尔', 1, 0, NOW(), NOW()
    WHERE NOT EXISTS (SELECT 1 FROM employees WHERE (id = 'c402ff6e-357c-4485-99ea-718916721eba' OR employee_number = 'E008' OR name = '如则托合提·阿卜杜加帕尔') AND soft_delete = 0);

    INSERT INTO employees (id, company_id, primary_site_id, employee_number, name, publish, soft_delete, created, modified)
    SELECT '72812ba5-b58c-4846-9566-abd4dc033c67', '00000000-0000-0000-0000-000000000001', 'c7264cf5-873e-4300-a9fc-866047c45879', 'E007', '米尔布拉·阿卜杜麦麦提', 1, 0, NOW(), NOW()
    WHERE NOT EXISTS (SELECT 1 FROM employees WHERE (id = '72812ba5-b58c-4846-9566-abd4dc033c67' OR employee_number = 'E007' OR name = '米尔布拉·阿卜杜麦麦提') AND soft_delete = 0);
    ...
    UPDATE qms_positions SET name = '总经理', modified = NOW()
    WHERE code = 'company_general_manager' AND publish = 1 AND soft_delete = 0 AND name <> '总经理';
    ...
    UPDATE qms_positions SET name = '最高管理者', modified = NOW()
    WHERE code = 'top_management' AND publish = 1 AND soft_delete = 0 AND name <> '最高管理者';
    ...
    WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 AND name <> '授权签字人';
    ...
    WHERE code = 'internal_auditor' AND publish = 1 AND soft_delete = 0 AND name <> '内审员';
    ...
    WHERE code = 'supervisor' AND publish = 1 AND soft_delete = 0 AND name <> '监督员';
    ...
    WHERE code = 'quality_manager' AND publish = 1 AND soft_delete = 0 AND name <> '质量负责人';
    ...
    UPDATE qms_positions SET name = 'LIMS系统管理员', modified = NOW()
    WHERE code = 'system_administrator' AND publish = 1 AND soft_delete = 0 AND name <> 'LIMS系统管理员';
    ...
    UPDATE qms_positions SET name = '场所质量协调人', modified = NOW()
    WHERE code = 'site_quality_coordinator' AND publish = 1 AND soft_delete = 0 AND name <> '场所质量协调人';
    ...
    WHERE code = 'technical_manager' AND publish = 1 AND soft_delete = 0 AND name <> '技术负责人';
    ...
    UPDATE qms_positions SET name = '文件管理员', modified = NOW()
    WHERE code = 'document_controller' AND publish = 1 AND soft_delete = 0 AND name <> '文件管理员';
    ...
    WHERE code = 'equipment_manager' AND publish = 1 AND soft_delete = 0 AND name <> '设备管理员';
    ...
    SELECT '6c03ef59-74b7-4260-841a-51f04be6bae7', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E000:company_general_manager:GLOBAL', 'role', '总经理', '总经理', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '0f2dc951-e603-46c8-8153-251ceab1633f', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E000:top_management:GLOBAL', 'role', '最高管理者', 'CMA 登记最高管理者', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'ff8162af-a44c-4a3c-857b-756b7b19c81d', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E000:authorized_signatory:GLOBAL', 'authorization', '授权签字人', '两场所灵活轮调授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '6e21f91a-1253-4ad0-8ee7-e8ad1b59198b', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E000:internal_auditor:GLOBAL', 'role', '内审员', '内审组员候选', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '66df0de5-f881-4af3-8bd3-d9ff17015d22', '00000000-0000-0000-0000-000000000001',
        ...
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E000:supervisor:PLACE02', 'role', '监督员', '和田实验室监督工作', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '8a96f080-dc50-4a36-87cc-9e97a3c3c2fe', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E002:quality_manager:GLOBAL', 'role', '质量负责人', '质量负责人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '002f17d8-21e2-4b14-8149-fca7b21ef31b', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E002' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'top_management' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        NULL, 'organization:E002:top_management:GLOBAL', 'role', '最高管理者', '内部最高管理者；不替代 CMA 登记最高管理者', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '67f0bfce-f238-48b9-83fa-8b0a85748df6', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E002' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        NULL, 'organization:E002:authorized_signatory:GLOBAL', 'authorization', '授权签字人', '两场所灵活轮调授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'a1b2945b-93a2-4dd0-8993-8a089b6092db', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E002' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'internal_auditor' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        NULL, 'organization:E002:internal_auditor:GLOBAL', 'role', '内审员', '通常担任内审组长', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '57a285a8-8a9d-4ea9-8bfe-2d691621ec69', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E002' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'supervisor' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E002:supervisor:PLACE01', 'role', '监督员', '乌鲁木齐实验室监督工作', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '0877674a-52d9-4ae1-8824-6360e71f913a', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E002:system_administrator:GLOBAL', 'responsibility', 'LIMS系统管理员', 'LIMS 系统管理员', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '0e4dbb1f-daa8-4fbd-8846-44c8a3a230f3', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E005:site_quality_coordinator:GLOBAL', 'role', '场所质量协调人', '质量负责人代理/两场所质量协调；代理启用需另行受控记录', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'e5702735-ae57-4db4-8a66-fae02b3e0ae8', '00000000-0000-0000-0000-000000000001',
        ...
        NULL, 'organization:E005:technical_manager:GLOBAL', 'role', '技术负责人', '总体技术责任人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'aedf30ad-3633-4e3d-8910-c2b2858ad938', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E005' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E005:authorized_signatory:PLACE01', 'authorization', '授权签字人', '乌鲁木齐授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'a7dff8ea-7bad-4db3-814d-00dfa6c06041', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E005' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E005:authorized_signatory:PLACE02', 'authorization', '授权签字人', '和田授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '541ac9ab-8023-4718-8025-5749f4eccd43', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E005' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'internal_auditor' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        NULL, 'organization:E005:internal_auditor:GLOBAL', 'role', '内审员', '内审组员候选', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT 'f685db8b-a2a2-4139-8721-074dbfc429bf', '00000000-0000-0000-0000-000000000001',
        ...
        (SELECT id FROM qms_positions WHERE code = 'technical_manager' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E003:technical_manager:PLACE01', 'role', '技术负责人', '乌鲁木齐技术负责人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '10bb6199-3d1e-4e53-8535-acbdba23d832', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E003' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E003:authorized_signatory:PLACE01', 'authorization', '授权签字人', '乌鲁木齐固定授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '772089a2-5f1d-46dc-8078-6def1fee5c0d', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E003' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'internal_auditor' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        NULL, 'organization:E003:internal_auditor:GLOBAL', 'role', '内审员', '内审组员候选', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '0804d76b-73f6-4ef8-8f95-7cfcde6b655a', '00000000-0000-0000-0000-000000000001',
        ...
        (SELECT id FROM qms_positions WHERE code = 'technical_manager' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E004:technical_manager:PLACE02', 'role', '技术负责人', '和田技术负责人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '0b30c83e-3a2d-472c-8fa9-9f6315fef872', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E004' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'authorized_signatory' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E004:authorized_signatory:PLACE02', 'authorization', '授权签字人', '和田固定授权签字人', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '4d503757-8720-4b3f-8cad-4e70ad24e292', '00000000-0000-0000-0000-000000000001',
        ...
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E006:document_controller:PLACE01', 'role', '文件管理员', '乌鲁木齐文件管理员', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '5859cc4e-64b5-49dd-8f6b-7efb3dd6f922', '00000000-0000-0000-0000-000000000001',
        ...
        (SELECT id FROM sites WHERE code = 'PLACE01' AND soft_delete = 0 LIMIT 1), 'organization:E010:equipment_manager:PLACE01', 'role', '设备管理员', '乌鲁木齐设备管理员', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    ...
    SELECT '9d728f0c-ee70-4db7-84fe-3afc3b7264cf', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E008' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'document_controller' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E008:document_controller:PLACE02', 'role', '文件管理员', '和田文件管理员', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    WHERE NOT EXISTS (SELECT 1 FROM employee_appointments WHERE appointment_key = 'organization:E008:document_controller:PLACE02' AND soft_delete = 0);
    ...
    SELECT 'ceec566e-8f33-47f0-8f5c-5406f32034f4', '00000000-0000-0000-0000-000000000001',
        (SELECT id FROM employees WHERE employee_number = 'E007' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM qms_positions WHERE code = 'equipment_manager' AND publish = 1 AND soft_delete = 0 LIMIT 1),
        (SELECT id FROM sites WHERE code = 'PLACE02' AND soft_delete = 0 LIMIT 1), 'organization:E007:equipment_manager:PLACE02', 'role', '设备管理员', '和田设备管理员', '2026-07-17', 'LIMS-TRIAL-ORG-20260717-01', '依据质量负责人确认、原岗位任命截图和现行人员台账，将真实组织岗位关系写入本机 LIMS 受控试运行；本确认不替代正式任命书、CMA 备案或个人电子签名。', 'corporate_evidence', 'active', 1, 0, NOW(), NOW()
    WHERE NOT EXISTS (SELECT 1 FROM employee_appointments WHERE appointment_key = 'organization:E007:equipment_manager:PLACE02' AND soft_delete = 0);

    UPDATE users SET employee_id = 'bf26c847-1181-4ed5-9881-563a6585475e', modified = NOW()
    WHERE username = 'admin' AND soft_delete = 0;

    IF (SELECT COUNT(*) FROM employee_appointments WHERE appointment_key IN ('organization:E000:company_general_manager:GLOBAL','organization:E000:top_management:GLOBAL','organization:E000:authorized_signatory:GLOBAL','organization:E000:internal_auditor:GLOBAL','organization:E000:supervisor:PLACE02','organization:E002:quality_manager:GLOBAL','organization:E002:top_management:GLOBAL','organization:E002:authorized_signatory:GLOBAL','organization:E002:internal_auditor:GLOBAL','organization:E002:supervisor:PLACE01','organization:E002:system_administrator:GLOBAL','organization:E005:site_quality_coordinator:GLOBAL','organization:E005:technical_manager:GLOBAL','organization:E005:authorized_signatory:PLACE01','organization:E005:authorized_signatory:PLACE02','organization:E005:internal_auditor:GLOBAL','organization:E003:technical_manager:PLACE01','organization:E003:authorized_signatory:PLACE01','organization:E003:internal_auditor:GLOBAL','organization:E004:technical_manager:PLACE02','organization:E004:authorized_signatory:PLACE02','organization:E006:document_controller:PLACE01','organization:E010:equipment_manager:PLACE01','organization:E008:document_controller:PLACE02','organization:E007:equipment_manager:PLACE02') AND soft_delete = 0) <> 25 THEN
        ROLLBACK;
