...
- stage2_review_approved_decisions: 154
- stage2_review_preview_items: 154
- stage2_review_preview_blocking_items: 0
- governance_readiness_gates: 13
- governance_readiness_blocking_gates: 0
- governance_readiness_tasks: 396
- governance_readiness_blocking_tasks: 0
- governance_closure_items: 396
- governance_closure_open_blocking_items: 0
- governance_closure_accepted_closures: 396
- governance_closure_execution_batches: 60
- governance_closure_execution_signatures: 50
- governance_closure_execution_pending_signatures: 0
- governance_closure_execution_pending_routes: 0
- governance_closure_pilot_batches: 5
- governance_closure_pilot_evidence_rows: 5
- governance_closure_pilot_pending_evidence: 0
- governance_closure_pilot_pending_handoffs: 0
- governance_closure_pilot_return_items: 5
- governance_closure_pilot_return_missing_fields: 0
- governance_closure_pilot_return_blocking_items: 0
- governance_closure_pilot_source_update_patch_rows: 55
- governance_closure_pilot_source_update_blocked_patches: 0
- governance_closure_pilot_source_update_ready_patches: 55
- governance_closure_pilot_operator_workbook_items: 5
- governance_closure_pilot_operator_workbook_pending_items: 0
- governance_closure_pilot_operator_workbook_field_items: 55
- governance_closure_pilot_operator_workbook_pending_fields: 0
- governance_closure_pilot_operator_workbook_handoff_items: 5
- governance_closure_pilot_operator_workbook_pending_handoffs: 0
- governance_closure_pilot_operator_handback_items: 5
- governance_closure_pilot_operator_handback_pending_items: 0
- governance_closure_pilot_operator_handback_field_items: 55
- governance_closure_pilot_operator_handback_pending_fields: 0
- governance_closure_pilot_operator_handback_handoff_items: 5
- governance_closure_pilot_operator_handback_pending_handoffs: 0
- governance_closure_pilot_operator_completion_simulation_items: 0
- governance_closure_pilot_operator_completion_simulation_field_items: 0
- governance_closure_pilot_operator_completion_simulation_handoff_items: 0
- governance_closure_pilot_operator_completion_simulation_pending_items: 0
- governance_closure_pilot_operator_completion_simulation_marker_rows: 0
- governance_closure_preview_items: 396
- governance_closure_preview_blocking_items: 0
- governance_closure_preview_accepted: 396
- governance_readiness_refresh_tasks: 396
- governance_readiness_refresh_blocking_tasks: 0
- governance_readiness_refresh_accepted_closures: 396
- findings: 0
...
- stage2_review_preview_readiness: ready_for_lims_apply
- stage2_review_preview_items: 154
- stage2_review_preview_blocking_items: 0
- governance_readiness_status: passed
- governance_readiness_readiness: ready_for_lims_apply
- governance_readiness_ready_for_lims_apply: yes
- governance_readiness_gates: 13
- governance_readiness_blocking_gates: 0
- governance_readiness_tasks: 396
- governance_readiness_blocking_tasks: 0
- governance_closure_status: passed
- governance_closure_readiness: ready_for_governance_readiness_refresh
- governance_closure_ready_for_governance_readiness_refresh: yes
- governance_closure_ready_for_lims_apply: no
- governance_closure_items: 396
- governance_closure_open_blocking_items: 0
- governance_closure_accepted_closures: 396
- governance_closure_execution_status: passed
- governance_closure_execution_readiness: ready_for_governance_closure_preview
- governance_closure_execution_ready_for_preview: yes
- governance_closure_execution_batches: 60
- governance_closure_execution_signature_rows: 50
- governance_closure_execution_pending_signatures: 0
- governance_closure_execution_pending_handoffs: 0
- governance_closure_execution_pending_routes: 0
- governance_closure_execution_blocking_routes: 0
- governance_closure_pilot_status: passed
- governance_closure_pilot_readiness: ready_for_governance_closure_preview
- governance_closure_pilot_ready_for_preview: yes
- governance_closure_pilot_batches: 5
- governance_closure_pilot_evidence_rows: 5
- governance_closure_pilot_handoff_rows: 5
- governance_closure_pilot_pending_evidence: 0
- governance_closure_pilot_pending_handoffs: 0
- governance_closure_pilot_blocking_items: 0
- governance_closure_pilot_return_status: passed
- governance_closure_pilot_return_readiness: ready_for_governance_closure_preview
- governance_closure_pilot_return_ready_for_preview: yes
- governance_closure_pilot_return_items: 5
- governance_closure_pilot_return_source_preview_rows: 10
- governance_closure_pilot_return_missing_fields: 0
- governance_closure_pilot_return_ready_items: 5
- governance_closure_pilot_return_blocking_items: 0
- governance_closure_pilot_source_update_status: passed
- governance_closure_pilot_source_update_readiness: ready_for_source_workbench_update
- governance_closure_pilot_source_update_ready_for_source_workbench_update: yes
- governance_closure_pilot_source_update_ready_for_preview: yes
- governance_closure_pilot_source_update_patch_rows: 55
- governance_closure_pilot_source_update_blocked_patches: 0
- governance_closure_pilot_source_update_ready_patches: 55
- governance_closure_pilot_source_update_manual_update_candidates: 55
- governance_closure_pilot_operator_workbook_status: passed
- governance_closure_pilot_operator_workbook_readiness: ready_for_pilot_return_preview
- governance_closure_pilot_operator_workbook_ready_for_pilot_return_preview: yes
...
- governance_closure_pilot_operator_handback_readiness: operator_handback_ready_for_return_preview
- governance_closure_pilot_operator_handback_ready_for_pilot_return_preview: yes
...
- governance_closure_pilot_operator_handback_pending_fields: 0
- governance_closure_pilot_operator_handback_pending_handoffs: 0
- governance_closure_pilot_operator_handback_completed_fields: 55
- governance_closure_pilot_operator_handback_completed_handoffs: 5
- governance_closure_pilot_operator_completion_simulation_status: not_provided
- governance_closure_pilot_operator_completion_simulation_readiness: 
- governance_closure_pilot_operator_completion_simulation_ready_for_pilot_return_preview: 
- governance_closure_pilot_operator_completion_simulation_ready_for_source_workbench_update: 
- governance_closure_pilot_operator_completion_simulation_ready_for_lims_apply: 
- governance_closure_pilot_operator_completion_simulation_is_simulated: 0
- governance_closure_pilot_operator_completion_simulation_items: 0
- governance_closure_pilot_operator_completion_simulation_field_items: 0
- governance_closure_pilot_operator_completion_simulation_handoff_items: 0
- governance_closure_pilot_operator_completion_simulation_pending_items: 0
...
- governance_closure_preview_readiness: ready_for_governance_readiness_refresh
- governance_closure_preview_ready_for_governance_readiness_refresh: yes
- governance_closure_preview_ready_for_lims_apply: no
- governance_closure_preview_items: 396
- governance_closure_preview_blocking_items: 0
- governance_closure_preview_accepted: 396
- governance_readiness_refresh_status: passed
- governance_readiness_refresh_readiness: ready_for_lims_apply
- governance_readiness_refresh_ready_for_lims_apply: yes
- governance_readiness_refresh_gates: 13
- governance_readiness_refresh_tasks: 396
- governance_readiness_refresh_blocking_tasks: 0
- governance_readiness_refresh_blocking_gates: 0
- governance_readiness_refresh_accepted_closures: 396
...
- pending_learning_tasks: 0
- pending_questions: 0
- blank_feedback_decisions: 0
...
- decision_items: 154
- proposed_decisions: 154
- not_proposed: 0
- pending_decisions: 0
- accepted_for_preview: 154
- invalid_decisions: 0
- missing_review_comments: 0
- blocking_items: 0
...
- manual_update_candidate_rows: 55
...
- readiness: operator_handback_ready_for_return_preview
- ready_for_pilot_return_preview: yes
- ready_for_source_workbench_update: no
- ready_for_lims_apply: no
- pilot_items: 5
...
- pending_field_items: 0
- pending_handoff_items: 0
- completed_field_items: 55
- completed_handoff_items: 5
- source_workbench_modified: 0
- database_write_performed: 0
...
- ready_for_lims_apply: no
- decision_items: 396
- proposed_closures: 396
- not_proposed: 0
- accepted_for_preview: 396
- invalid_closures: 0
