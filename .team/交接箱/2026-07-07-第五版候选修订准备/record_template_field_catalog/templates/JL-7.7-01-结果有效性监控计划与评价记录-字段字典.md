...
- 适用条款：7.7
- 关联程序：XZTC/CX-15-2022；XZTC/CX-16-2022；XZTC/CX-30-2022；XZTC/CX-34-2022
- 填写责任：技术负责人/质量负责人
- 形成时机：年度策划、质控活动后
- 字段总数：17
- 需人工确认字段：17
...
|---|---|---|---|---|---|---|---|---|
| 1 | record_number | 记录编号 | text | yes | common | SIM-JL-7.7-01-20260707-001 | yes | 候选字段需文件管理员确认 |
| 2 | record_name | 记录名称 | text | yes | common | 结果有效性监控计划与评价记录 | yes | 候选字段需文件管理员确认 |
| 3 | applicable_clause | 适用条款 | text | yes | common | 7.7 | yes | 候选字段需文件管理员确认 |
| 4 | related_procedure | 关联程序 | text | yes | common | XZTC/CX-15-2022；XZTC/CX-16-2022；XZTC/CX-30-2022；XZTC/CX-34-2022 | yes | 候选字段需文件管理员确认 |
| 5 | responsible_position | 填写责任 | text | yes | common | 技术负责人/质量负责人 | yes | 候选字段需文件管理员确认 |
| 6 | trigger_time | 形成时机 | text | yes | common | 年度策划、质控活动后 | yes | 候选字段需文件管理员确认 |
...
| 12 | specific_01_e8513e4d | 监控方式 | text | yes | specific | 模拟：监控方式待按真实业务填写。 | yes | 需过程负责人确认字段含义和现用表单一致性 |
| 13 | specific_02_e1668a04 | 频次 | text | yes | specific | 模拟：频次待按真实业务填写。 | yes | 需过程负责人确认字段含义和现用表单一致性 |
...
| 17 | specific_06_d8e38b5f | 改进 | text | yes | specific | 模拟：改进待按真实业务填写。 | yes | 需过程负责人确认字段含义和现用表单一致性 |
...
- `specific_01_e8513e4d`：需过程负责人确认字段含义和现用表单一致性
- `specific_02_e1668a04`：需过程负责人确认字段含义和现用表单一致性
...
- `specific_06_d8e38b5f`：需过程负责人确认字段含义和现用表单一致性
