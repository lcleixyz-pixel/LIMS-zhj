...
- 填写责任：文件管理员
- 形成时机：新版文件生效、旧版文件回收、作废留存或销毁时
- 来源演练文件：04-旧版处置演练清单.csv
- 来源演练行数：28
...
|---|---|---|---|---|---|---|
| 1 | record_number | 记录编号 | text | yes | SIM-JL-REL-04-20260707-001 | 通用治理字段，正式启用前需由文件管理员确认。 |
| 2 | record_name | 记录名称 | text | yes | 旧版文件回收作废与留存记录 | 通用治理字段，正式启用前需由文件管理员确认。 |
...
| 6 | trigger_time | 形成时机 | text | yes | 新版文件生效、旧版文件回收、作废留存或销毁时 | 通用治理字段，正式启用前需由文件管理员确认。 |
...
| 9 | evidence_reference | 证据位置 | text | yes | 04-旧版处置演练清单.csv | 通用治理字段，正式启用前需由文件管理员确认。 |
...
| 15 | obsolete_object | 作废对象 | text | yes | 模拟：作废对象待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
| 16 | old_version | 旧版版本/编号 | text | yes | 模拟：旧版版本/编号待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
| 17 | recycle_method | 回收或作废方式 | text | yes | 模拟：回收或作废方式待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
| 18 | retained_copy_location | 作废留存位置 | text | no | 模拟：作废留存位置待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
| 19 | disposal_result | 处置结果 | text | yes | 模拟：处置结果待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
| 20 | verifier | 验证人 | text | yes | 模拟：验证人待按真实发布执行填写。SIMULATED_TRIAL_NOT_REAL_RECORD | 需人工确认字段含义、填写责任、保存和复核要求。 |
