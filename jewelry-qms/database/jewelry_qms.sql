...
CREATE TABLE `qms_requirement_elements` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
...
CREATE TABLE `qms_element_clause_mappings` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
...
CREATE TABLE `qms_responsibility_matrix` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
...
CREATE TABLE `qms_document_sections` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
...
CREATE TABLE `qms_import_batches` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
  `name` varchar(300) NOT NULL,
...
CREATE TABLE `qms_import_candidates` (
  `id` varchar(36) NOT NULL,
  `company_id` varchar(36) NOT NULL,
