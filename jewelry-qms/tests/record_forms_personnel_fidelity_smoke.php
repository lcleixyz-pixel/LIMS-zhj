...
function personnel_values_for(string $printTemplateKey): array
{
    return match ($printTemplateKey) {
        ...
        'training_record' => [
            ...
            'training_place' => '和田实验室会议室',
            'trainer' => '质量负责人',
            'training_materials' => '记录控制程序与新版表格蓝图',
            'training_target_scope' => '两场所检测人员',
            'assessment_method' => '提问',
            'training_content' => '模板 smoke',
            'attendees' => [['name' => '张三', 'position' => '检测员', 'signature' => '张三']],
        ...
        'rf_xztc_bg_01_06_f268e9aaf1' => [
            ...
            'estimated_cost' => '2000',
            'expected_capability' => '掌握CMA新规下记录填写与标志使用要求',
            'technical_manager_review_opinion' => '外委名单符合培训计划，同意参加',
            'technical_manager' => '技术负责人',
            'technical_manager_review_date' => '2026-05-21',
            'lab_director_approval_opinion' => '批准',
            'lab_director' => '实验室主任',
            'lab_director_approval_date' => '2026-05-22',
            'remarks' => '按计划执行',
        ],
...
$expected = [
    ...
    'XZTC/BG-01-02|人员培训记录表' => [
        ...
        'keys' => ['usage_site', 'training_topic', 'training_category', 'training_date', 'training_place', 'trainer', 'training_provider', 'training_materials', 'training_target_scope', 'assessment_method', 'attendees', 'training_content', 'assessment_result', 'effect_evaluation_note', 'recorder', 'record_date', 'archive_note'],
        'needles' => ['人员培训记录表', 'XZTCH-BG-01-02', '版次：A/0', '保存期限：不少于6年', '培训类别', '教材/资料', '岗位', '复印件入个人技术档案'],
    ],
    ...
    'XZTC/BG-01-06|培训申请表' => [
        ...
        'keys' => ['usage_site', 'applicant', 'application_department', 'application_date', 'training_category', 'training_content', 'participants', 'training_provider', 'training_place', 'training_time', 'estimated_cost', 'expected_capability', 'technical_manager_review_opinion', 'technical_manager', 'technical_manager_review_date', 'lab_director_approval_opinion', 'lab_director', 'lab_director_approval_date', 'remarks'],
        'needles' => ['培训申请表', 'XZTCH-BG-01-06', '版次：A/0', '保存期限：不少于6年', '培训类别', '预期目标/能力要求', '技术负责人审核', '实验室主任批准', 'CMA 体系换版培训'],
    ],
