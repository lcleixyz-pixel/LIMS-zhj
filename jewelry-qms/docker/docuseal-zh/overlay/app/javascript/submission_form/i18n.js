...
const zh = {
  ...
  signature_drawing_area: '签名绘图区。使用鼠标或触摸来绘制您的签名。',
  initials_drawing_area: '缩写绘图区。使用鼠标或触摸来绘制您的姓名缩写。',
  kba: 'KBA',
  please_upload_an_image_file: '请上传图像文件',
  must_be_characters_length: '长度必须为 {number} 个字符',
  must_be_valid_ssn: '必须是有效的 SSN (XXX-XX-XXXX)',
  must_be_valid_ein: '必须是有效的 EIN (XX-XXXXXXX)',
  must_be_valid_email: '必须是有效的电子邮件地址',
  must_be_valid_url: '必须是有效的 URL（以 http:// 或 https:// 开头）',
  must_be_valid_zip: '必须是有效的邮政编码（XXXXX 或 XXXXX-XXXX）',
  must_contain_numbers_only: '必须仅包含数字',
  must_contain_letters_only: '必须仅包含字母',
  complete_all_required_fields_to_proceed_with_identity_verification: '填写所有必填字段以继续进行身份验证。',
  verify_id: '验证身份',
  identity_verification: '身份验证',
  complete: '完成',
  fill_all_required_fields_to_complete: '填写所有必填字段以完成',
  sign_and_complete: '签名并完成',
  text: '文本',
  ...
  reviewed_by: '审阅者',
  authored_by: '作者：',
  select_a_reason: '选择一个原因',
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: '使用相机应用扫描二维码，在手机上打开表格并签名',
  date: '日期',
  number: '数字',
  ...
  pay: '支付',
  take_photo: '拍照',
  number_phone_is_invalid: '{number} 电话无效',
  file: '文件',
  ...
  complete_hightlighted_checkboxes_and_click: '完成突出显示的复选框并单击',
  submit: '提交',
  next: '下一步',
  ...
  upload: '上传',
  files: '文件',
  signature_is_too_small_or_simple_please_redraw: '签名太小或太简单。请重画。',
  browser_privacy_settings_block_canvas: '您的浏览器隐私设置限制绘图画布的使用。请使用其他浏览器或设备，或者禁用阻止画布进行签名的隐私设置。',
  wait_countdown_seconds: '等待 {倒计时} 秒',
