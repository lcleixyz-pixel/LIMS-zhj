...
const zh = {
  ...
  payment_link: '付款链接',
  strikeout: '三振',
  draw_strikethrough_the_document: '在文档中画删除线',
  quantity: '数量',
  prefillable: '可预填充',
  signature_id: '签名ID',
  error_message: '错误信息',
  ...
  verify_id: '验证身份',
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more: '通过可信提供商获得合格的电子签名 (QeS)。点击了解更多。',
  editable: '可编辑',
  recurrent: '复发性',
  one_off: '一次性的',
  search_field: '搜索栏',
  ...
  uploaded_pdf_contains_form_fields_keep_or_remove_them: '上传的 PDF 包含表单字段。保留还是删除它们？',
  keep: '保持',
  left: '左边',
  heading: '标题',
  validation: '验证',
  ...
  list: '列表',
  no_variables: '还没有变量',
  no_variables_description: '将 [[variable]] 标记添加到文档中以创建动态内容变量。',
  type_value: '类型值',
  equal: '平等的',
  not_equal: '不等于',
  greater_than: '大于',
  ...
  are_you_sure_: '你确定吗？',
  sign_yourself: '自己签名',
  set_signing_date: '设定签署日期',
  signing_date: '签署日期',
  signing_date_and_time: '签署日期和时间',
  send: '发送',
  remove: '消除',
  edit: '编辑',
  settings: '设置',
  ...
  any: '任何',
  drawn: '绘制',
  drawn_or_typed: '绘制或打印',
  drawn_or_upload: '绘制或上传',
  upload: '上传',
  formula: '公式',
  typed: '打字的',
  draw_field_on_the_document: '在文档上绘制一个字段',
  click_to_upload: '点击上传',
  or_drag_and_drop_files: '或拖放文件',
  uploading: '上传中',
  processing_: '加工...',
  add_pdf_documents_or_images: '添加 PDF 文档或图像',
  add_documents_or_images: '添加文档或图像',
  add_a_new_document: '添加新文档',
  edit_documents: '编辑文档',
  move_forward: '前进',
  move_backward: '向后移动',
  remove_page: '删除页面',
  merge_with_previous: '与之前的合并',
  merge_with_next: '与下一个合并',
  move_up: '向上移动',
  move_down: '下移',
  rotate: '旋转',
  redact: '纂',
  ...
  flip_vertical: '垂直翻转',
  there_is_no_text_to_redact_on_this_page: '该页面仅包含图像。编辑工具只能用于文本页面',
  color: '颜色',
  reset: '重置',
  upload_to_document: '上传至“{文档}”',
  replace_existing_document: '替换现有文档',
  clone_and_replace_documents: '克隆和替换文档',
  required: '必需的',
  default_value: '默认值',
  format: '格式',
  read_only: '只读',
  ...
  sixteenth_party: '第十六党',
  seventeenth_party: '第十七党',
  eighteenth_party: '第十八党',
  nineteenth_party: '第十九党',
  twentieth_party: '第二十方',
  draw: '手写',
  add: '添加',
  or_add_field_without_drawing: '或者添加字段而不绘图',
  text: '文本',
  number: '数字',
  signature: '签名',
  initials: '缩写签名',
  ...
  drag_and_drop_any_other_field_type_on_the_page: '将任何其他字段类型拖放到页面上',
  click_on_the_field_type_above_to_start_drawing_it: '单击上面的字段类型开始绘制它',
  please_draw_fields_to_prepare_the_document: '请画出字段来准备文件。',
  only_pdf_and_images_are_supported: '仅支持 PDF 和图像。',
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification: '使用付费套餐解锁短信验证的电话号码字段。使用文本字段输入电话号码，无需验证。',
  available_only_in_pro: '仅适用于专业版',
  failed_to_download_files: '下载文件失败',
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed: '请添加 {submitter_name} 的字段。或者，如果不需要，请删除 {submitter_name}。',
  ...
  number_range: '号码范围',
  enter_pdf_password: '输入PDF密码',
  wrong_password: '密码错误',
  currency: '货币',
  save_and_preview: '保存并预览',
  preferences: '偏好设置',
  available_in_pro: '专业版可用',
  some_fields_are_missing_in_the_formula: '公式中缺少某些字段。',
  learn_more: '了解更多',
  and: '和',
  or: '或者',
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document: '开始快速浏览以了解如何创建和发送您的第一个文档',
  start_tour: '开始游览',
  or_add_from: '或添加自',
  sync: '同步',
  syncing: '正在同步...',
  ...
  field_added: '添加了 {count} 个字段',
  fields_added: '添加了 {count} 个字段',
  revisions: '修订',
  apply: '申请',
  no_revisions_yet: '还没有修改',
  viewing_revision_from: '查看自 {date} 起的修订',
  connect_google_drive: '连接 Google 云端硬盘',
  submitting: '提交中',
}
